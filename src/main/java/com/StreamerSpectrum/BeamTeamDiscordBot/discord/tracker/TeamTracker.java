...
public class TeamTracker {
	...
	public boolean add(BeamTeam team) {
		...
		if (added) {			
			// TODO: check if go-live or log channel is set, then subscribe all team members to constellation for go-live
			// TODO: check if new member announce channel is set, then subscribe to team member join
			// TODO: check if log channel is set, then subscribe to team member leave
		}
